<div class="row-cpod">
    ...
    $query = 'SELECT * FROM services WHERE services_id = 1';
            ...
            echo '
                <div class="col-sm-8" style="padding: 0px 0px 40px">
                    <div id="edit-delete-article-col" class="col-sm-12">
                        <a id="button-edit" data-id="1" href="edit_services.php?servicesid=1" class="btn btn-primary btn-block" target="_blank">Edit Article</a>
                    </div>
                </div>
            </div>
            ';
