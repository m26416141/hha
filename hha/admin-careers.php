            ...
            <form method="POST" id="form-careers">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-6">
                        ...
                        <select class="custom-select my-1 mr-sm-2 form-place" name="locations" id="inputPlace" style="margin-top: 0px !important; margin-bottom: 0px !important; height: auto; padding-bottom: 12px;">
